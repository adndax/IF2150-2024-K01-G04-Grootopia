...
class Sidebar(QWidget):
    ...
    def setup_ui(self):
        # Set font yang lebih tebal
        self.inter_font = QFont("Arial", 12, QFont.Bold)
        
        # Main layout tanpa margins
        layout = QVBoxLayout(self)
        layout.setSpacing(15)
        layout.setContentsMargins(0, 0, 0, 0)  # Hilangkan margins
        ...
        title = QLabel()
        title_font = QFont("Arial", 14, QFont.Bold)  # Buat lebih tebal
        title.setFont(title_font)
        title.setText('<span style="color: #59694D;">Groo</span><span style="color: #6C4530;">topia</span>')
        title.setTextFormat(Qt.RichText)
